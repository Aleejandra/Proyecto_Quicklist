 ...
 * @author pabloycesar
 */
public class Pantalla_Editar_MisDatos extends javax.swing.JFrame {

    /**
     * Creates new form PantallaDeIngreso
     */
    public Pantalla_Editar_MisDatos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pantalla_Editar_MisDatos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pantalla_Editar_MisDatos().setVisible(true);
            }
        });
    }
