 ...
 * @author pabloycesar
 */
public class Pantalla_VerListadoDeAprendices extends javax.swing.JFrame {

    /**
     * Creates new form PantallaDeIngreso
     */
    public Pantalla_VerListadoDeAprendices() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pantalla_VerListadoDeAprendices.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pantalla_VerListadoDeAprendices().setVisible(true);
            }
        });
    }
