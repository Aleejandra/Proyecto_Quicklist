 ...
 * @author pabloycesar
 */
public class Pantalla_AgregarInstructores extends javax.swing.JFrame {

    /**
     * Creates new form PantallaDeIngreso
     */
    public Pantalla_AgregarInstructores() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pantalla_AgregarInstructores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pantalla_AgregarInstructores().setVisible(true);
            }
        });
    }
